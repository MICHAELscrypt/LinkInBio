...
class UserLinkForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'belongs_to_socialplatform': forms.Select(),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['belongs_to_socialplatform'].widget = forms.Select(choices=[(sp.id, sp.name) for sp in socialPlatform.objects.all()])
